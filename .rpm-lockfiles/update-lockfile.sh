...
#
# Examples:
#   .rpm-lockfiles/update-lockfile.sh release-0.22              # Update all components
#   .rpm-lockfiles/update-lockfile.sh release-0.22 nettest      # Update single component
#
# Prerequisites:
...
if [ "$#" -lt 1 ]; then
  ...
  echo "Example: $0 release-0.22 nettest" >&2
  exit 1
fi
